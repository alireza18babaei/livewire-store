        ...
        <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
            <div class="flex justify-between">
                ...
                <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                    <a href="#" @click="toggle">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-70 hover:opacity-80">
                    ...
                    >
                        <li><a href="#" @click="toggle">مشاهده گزارش</a></li>
                        <li><a href="#" @click="toggle">ویرایش گزارش</a></li>
                    </ul>
                </div>
            </div>
