...
<head>
  ...
  <link rel="stylesheet"
    type="text/css"
    media="screen"
    href="{{ asset('panel/css/perfect-scrollbar.min.css') }}"/>

  {{--
  <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('panel/css/style.css') }}" />--}}
  {{--    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('tailwind/assets/app-D-fgq9FV.css') }}"/>--}}
  @vite('resources/css/app.css')
  <link defer
    rel="stylesheet"
    type="text/css"
    media="screen"
    href="{{ asset('panel/css/animate.css') }}"/>
  <script src="{{ asset('panel/js/perfect-scrollbar.min.js') }}"></script>
  <script defer
    src="{{ asset('panel/js/popper.min.js') }}"></script>
  <script defer
    src="{{ asset('panel/js/tippy-bundle.umd.min.js') }}"></script>
  <script defer
    src="{{ asset('panel/js/sweetalert.min.js') }}"></script>
</head>
...
<body x-data="main"
          ...
          <ol class="flex space-x-2 rtl:space-x-reverse mb-4">
            ...
            @foreach($breadcrumb as $crumb)
              <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                @if(isset($crumb['link']))
                  <a href="{{ route($crumb['link'], $crumb['params'] ?? []) }}" class="text-primary hover:underline">
                    {{ $crumb['label'] }}
                  </a>
                @else
  ...
  <script defer
    src="{{ asset('panel/js/apexcharts.js') }}"></script>
